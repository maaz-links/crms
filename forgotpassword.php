...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $exists=false;
    $sql = "SELECT * FROM `tblusers` WHERE `user_email` = '$email' AND `user_contact` = '$contactno' ";
    ...
    if($password == $cpassword){
        ...
        $sql = "UPDATE `tblusers` SET `user_password` = '$password' WHERE `tblusers`.`user_id` = '$currentuser'";
        $result = mysqli_query($conn, $sql);
        if ($result){
          $notifySuccess= true;
        }
      ...
      <div class="row gx-lg-5 align-items-center">
        <div class="col-lg-6 mb-5 mb-lg-0">
          <h1 class="my-5 display-3 fw-bold ls-tight">
            Easy and Fast way <br> to <span class="text-danger">Rent</span> your Car <br />
          </h1>
        ...
        <div class="col-lg-6 mb-5 mb-lg-0">
          <div class="card">
            ...
            <form action="/crms/forgotpassword.php" method="post">

                <div data-mdb-input-init class="form-outline mb-3">
                <?php
                  if($InvalidCredentials){
                    echo '<p class="text-danger">Invalid Email or corresponding Contact Number</p>';
                  }
                ?>
                ...
                <?php
                  if($showError){
                    echo '<p class="text-danger">Password and Confirm Password Fields do not match.</p>';
                  }else{
                ...
                <p class="small fw-bold mt-2 pt-1 mb-4"><a href="login.php"
                class="link-success">Back to Login</a></p>
                </div>
